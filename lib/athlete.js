...
athlete.prototype.get = async function (args) {
  ...
  return /** @type {Promise<SummaryAthlete>} */ (await this.client.getEndpoint(endpoint, args))
}
...
athlete.prototype.update = async function (args) {
  ...
  return /** @type {Promise<SummaryAthlete>} */ (await this.client.putEndpoint(endpoint, args))
}
...
athlete.prototype._listHelper = async function (listType, args) {
  ...
  return /** @type {Promise<DetailedActivity[]|Route[]|SummaryClub[]|ActivityZone[]>} */ (await this.client.getEndpoint(endpoint, args))
}
