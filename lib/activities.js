...
/**
 * List activity laps. No pagination; only activity id is used.
 * @param {DetailRoute} args
 * @returns {Promise<Lap[]>}
 * @throws {Error} When args.id is missing
 */
...
/**
 * List activity comments (cursor-based: page_size, after_cursor).
...
/**
 * List activity kudoers (page/per_page pagination).
