...
RateLimit.readExceeded = function () {
  if (rl.readShortTermUsage >= rl.readShortTermLimit) {
    return true
  }

  if (rl.readLongTermUsage >= rl.readLongTermLimit) {
    return true
  }
...
RateLimit.readFractionReached = function () {
  var shortLimitFraction = rl.readShortTermUsage / rl.readShortTermLimit
  var longLimitFraction = rl.readLongTermUsage / rl.readLongTermLimit
